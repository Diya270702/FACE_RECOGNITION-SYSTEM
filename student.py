...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p19.jpeg")
        ...
        #second image
        img1=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p19.jpeg")
        ...
        #third image
        img2=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p19.jpeg")
        ...
        #bg image
        img3=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p6.jpeg")
        ...
        img_left=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p20.png")
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=17,font=("times new roman",13,"bold"),bg="purple",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times new roman",13,"bold"),bg="purple",fg="white")
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=17,font=("times new roman",13,"bold"),bg="purple",fg="white")
        delete_btn.grid(row=0,column=2)
        
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=17,font=("times new roman",13,"bold"),bg="purple",fg="white")
        reset_btn.grid(row=0,column=3)
        
        btn_frame1=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=200,width=680,height=35)
        
        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=34,font=("times new roman",13,"bold"),bg="purple",fg="white")
        take_photo_btn.grid(row=0,column=0)
        
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=34,font=("times new roman",13,"bold"),bg="purple",fg="white")
        ...
        img_right=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FACE_RECOGNITION SYSTEM\picss\p22.jpeg")
        img_right=img_right.resize((615,130),Image.ANTIALIAS)
        ...
        search_btn=Button(Search_frame,text="Search",width=10,font=("times new roman",12,"bold"),bg="purple",fg="white")
        search_btn.grid(row=0,column=3,padx=3)
        
        showAll_btn=Button(Search_frame,text="Show All",width=10,font=("times new roman",12,"bold"),bg="purple",fg="white")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,year=%s,semester=%s,Name=%s,Division=%s,Roll=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_ID=%s", (
                                                                                                                                                                                                            self.var_dep.get(),
                                                                                                                                                                                                            self.var_course.get(),
                                                                                                                                                                                                            self.var_year.get(),
                                                                                                                                                                                                            self.var_semester.get(),
