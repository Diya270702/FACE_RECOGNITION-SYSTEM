...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"picss\p29.jpeg")
        ...
        #second image
        img1=Image.open(r"picss\p30.jpeg")
        ...
        img_left=Image.open(r"picss\p20.png")
        ...
        left_inside_frame.place(x=0,y=155,width=685,height=250)
        ...
        #date
        dateLabel=Label(left_inside_frame,text="Name:",font=("comicsansns",11,"bold"),bg="white")
        ...
        save_btn=Button(btn_frame,text="Import csv",width=17,command=self.importCsv,font=("times new roman",13,"bold"),bg="purple",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Export csv",width=17,command=self.exportCsv,font=("times new roman",13,"bold"),bg="purple",fg="white")
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Update",width=17,font=("times new roman",13,"bold"),bg="purple",fg="white")
